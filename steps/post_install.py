...
username = subprocess.check_output("whoami", shell=True, stderr=subprocess.STDOUT).decode()
...
os.system("$(curl -fsSL https://raw.githubusercontent.com/robbyrussell/oh-my-zsh/master/tools/install.sh) --unattended")
...
os.system("cd ~ && git clone https://aur.archlinux.org/yay-bin.git && cd yay-bin && makepkg -s")
